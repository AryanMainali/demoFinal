    ...
    return (
        <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
            {/* Sidebar (used only for admin; students and faculty use top nav only).
                Hide sidebar on the main admin dashboard for a cleaner, top-nav-only layout. */}
            ...
            {/* Main Content */}
            <div className={`flex-1 flex flex-col min-h-0 overflow-hidden ${isAdmin && !isAdminDashboard ? 'lg:pl-72' : ''}`}>
                {/* Top Header */}
